...
import { CompactLightLayoutModule } from 'app/layout/layouts/vertical/compactlight/compactlight.module';
...
import { ClassicLightLayoutModule } from './layouts/vertical/classiclight/classiclight.module';
...
const layoutModules = [
    ...
    // Vertical navigation
    ClassicLayoutModule,
    ClassicLightLayoutModule,
    ClassyLayoutModule,
    CompactLayoutModule,
    CompactLightLayoutModule,
    DenseLayoutModule,
